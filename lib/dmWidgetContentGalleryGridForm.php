...
class dmWidgetContentGalleryGridForm extends dmWidgetPluginForm
{
  protected static
  $methods = array(
    'center' => 'Center',
  ...
  public function getStylesheets()
  {
    return array(
      'lib.ui-tabs',
      'dmWidgetGalleryGridPlugin.form'
    );
  }
  ...
  {
    return $this->getHelper()->renderPartial('dmWidgetGalleryGrid', 'form', array(
      'form' => $this,
      'medias' => $this->getMedias(),
      'baseTabId' => 'dm_widget_gallery_grid_'.$this->dmWidget->get('id')
    ));
  }
